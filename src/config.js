...
export function defaultConfig() {
  return {
    ...
    media: {
      image: { enabled: false, adapter: "comfyui", service: "", baseURL: "", model: "", workflow: null, timeoutSeconds: 900, inputMap: {}, outputMap: {}, cli: { enabled: false, command: "", args: [], env: {}, pathPrepend: "", referenceFlag: "", timeoutSeconds: 900, outputExtension: ".png" } },
      video: { enabled: false, adapter: "comfyui", service: "", baseURL: "", model: "", workflow: null, timeoutSeconds: 3600, maxDurationSeconds: 15, inputMap: {}, outputMap: {} },
...
export function installPaths(installDir) {
  ...
  return {
    ...
    mcpToolsMain: path.join(resources, "mcp-tools", "dist", "main.js"),
    baseConfigs: [
